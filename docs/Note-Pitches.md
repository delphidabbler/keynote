| **MIDI note number** | **Integer Notation** | **Key number (Organ)** | **Key number (Piano)** | **Note names (English)** | **Note names (German)** | **Frequency (equal temperament  tuning at 440 Hz)** | **Notes** |
| ---:| ---:| ---:| ---:|:---------:|:-------------------:| --------:|-|
